...
using VirtualDice.Server.Data;
using VirtualDice.Server.Services;

namespace VirtualDice.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<RaceServiceOptions>(o => o.AddAssembly<Human>());
            services.AddScoped<IRaceService, RaceService>();
            services.AddOrm(Configuration);

            services.AddLocalization(o => o.ResourcesPath = "");
            services.Configure<RequestLocalizationOptions>(o => {
                o.DefaultRequestCulture = new RequestCulture(new CultureInfo("fr"));
